...
from .views import UserPostsView,UserMediaView,Search,UserRepliesView,UserLikesView,UserFollow,UserFollowers,UserFollowings
from .authViews import VerifyOldPasswordView,ChangeUserPasswordView,RequestForgetPWDOTP,CheckFPWOTPView,SetNewPassword
urlpatterns = [
    ...
    path("user/<int:user_id>/media/",UserMediaView.as_view(),name='get-user-posts'),
    ...
    path("auth/set-new-password/",SetNewPassword.as_view(),name='set-new-password'),
