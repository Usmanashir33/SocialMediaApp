...
class FollowingNotification(models.Model):
    ...
    members = models.ManyToManyField(User, verbose_name=_("following notif members"),blank=True,related_name='followingNotif')
    readers = models.ManyToManyField(User, verbose_name=_("notification readers"),blank=True,related_name='readFNotif')
