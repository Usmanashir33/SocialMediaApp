...
class FollowingNotification(models.Model):
    ...
    follower = models.ForeignKey(User, verbose_name=_("follower"), relateon_delete=models.DO_NOTHING,blank=True)
    following = models.ForeignKey(User, verbose_name=_("following"),relate on_delete=models.DO_NOTHING,blank=True)
