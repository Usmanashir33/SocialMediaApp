...
class FollowingNotification(models.Model):
    ...
    follower = models.ForeignKey(User, verbose_name=_("follower"), relatedon_delete=models.DO_NOTHING,blank=True)
    following = models.ForeignKey(User, verbose_name=_("following"),related on_delete=models.DO_NOTHING,blank=True)
