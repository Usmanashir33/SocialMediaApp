...
class FollowingNotification(models.Model):
    ...
    follower = models.ForeignKey(User, verbose_name=_("follower"), reon_delete=models.DO_NOTHING,blank=True)
    following = models.ForeignKey(User, verbose_name=_("following"),re on_delete=models.DO_NOTHING,blank=True)
