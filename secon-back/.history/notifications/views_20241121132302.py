...
from .serializers import NotificationSerializer,FNotificationSerializerNotificationSerializer
...
class UserNotificationView(APIView): 
    def get(self, request):
        try:
            ...
            follow_serializer = NotificationSerializer(com_notifications,many=True)
