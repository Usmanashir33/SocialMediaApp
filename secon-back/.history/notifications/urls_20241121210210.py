...
urlpatterns = [
    ...
    path("mine/delete/<int:notification_id>/commu",UserDeleteNotificationView.as_view(),name='delete-mine-notifications'),
    path("mine/delete/<int:notification_id>/",UserDeleteNotificationView.as_view(),name='delete-mine-Fnotifications'),
]
