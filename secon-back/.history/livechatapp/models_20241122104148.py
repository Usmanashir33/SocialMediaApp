...
class Message(models.Model):
    ...
    delete_for_me = models.ManyToManyField(User, verbose_name=_("delete for me"))
...
class CommunityChat(models.Model):
    ...
    delete_for_me = models.ManyToManyField(User, verbose_name=_("delete for me") ,related_name='cdelforme',blank=tr)
    # delete_for_all = models.BooleanField(_("delete for all"),default=False)
