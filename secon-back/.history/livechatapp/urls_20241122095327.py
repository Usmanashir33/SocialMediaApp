...
from .views import AllChats,GetUserMessages,GetAllCommunities,CommunityData,UnreadChats,DeleteMessageForMe
...
urlpatterns = [
    ...
    # path('chatroom/<int:user_id>/unread',UnreadChats.as_view(),name='chat-room'),
    path('chatroom/<int:user_id>/',GetUserMessages.as_view(),name='unread-chat'),
    path('chatroom/delete/<int:message_id>/forme',DeleteMessageForMe.as_view(),name='delete-chat-for-me'),
