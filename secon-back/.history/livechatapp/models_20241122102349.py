...
class Message(models.Model):
    ...
    delete_for_me = models.ManyToManyField(User, verbose_name=_("ownership"),default=[self.user_from.id,user_to.id])
...
class CommunityChat(models.Model):
    ...
    delete_for_me = models.BooleanField(_("delete for me"),default=False)
    # delete_for_all = models.BooleanField(_("delete for all"),default=False)
