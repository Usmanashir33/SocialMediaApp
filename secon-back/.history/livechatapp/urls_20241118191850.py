...
from .views import AllChats,GetUserMessages,GetAllCommunities,CommunityData
...
urlpatterns = [
    ...
    path('chatroom/<int:user_id>/unread',GetUserMessages.as_view(),name='unread-chat'),
    path('chatroom/<int:user_id>/',GetUserMessages.as_view(),name='chat-room'),
