...
ALLOWED_HOSTS = [ 'localhost','127.0.0.1','192.168.161.26',"f830-102-91-92-152.ngrok-free.app"]
# ALLOWED_HOSTS = [ ]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=0),
...
CORS_ALLOWED_ORIGINS = [
    ...
    'http://192.161.167.26:3000', # my system ip address
    "http://105.113.29.234:3000", #phoneipadress
]
