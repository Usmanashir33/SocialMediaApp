...
class PostView(APIView):
    ...
    def put(self, request, id,format=None):
        try:
            ...
            if post.user.id == request.user.id and not_blank != "null":
...
class PostAssoComment(APIView):
    ...
    def put(self, request, comment_id,format=None):
        ...
        try:
            ...
            if comment.user.id == user_id and not_blank != "null" :
...
class CommentReplies(APIView):
    ...
    def post(self, request, comment_id, format=None):
        # try:
            ...
            not_blank = body or file 
            reply = {
                'body':body,"user":user.id,'file':file,'post':post_id,"parent" : comment_id
                } if file != 'null' else {
            ...
            if serializer.is_valid() andnot_blank != "null":
                serializer.save()
