...
class PostsView(APIView):
    ...
    def post(self, request, format=None):
        # try:
            ...
            serializer = PosterSerializ+er(data={'body':body,"user":user.id},files=request.FILES)
            serializer = PosterSerializer(data={'body':body,"user":user.id},files=request.FILES)
