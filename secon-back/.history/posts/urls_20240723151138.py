...
urlpatterns = [
    ...
    path('comment/<int:comment_id>/replies/',PostAssoComments.as_view(),name='comment-replies'),
    path('comment/<int:comment_id>/reply/',PostAssoComment.as_view(),name='comment-reply'),
]