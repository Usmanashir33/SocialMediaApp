...
from .views import CommentReply,CommentReplies,FollowingPostsView,PostLikeView,CommentLikeView
urlpatterns = [
    path('posts/',PostsView.as_view(),name='posts'),
    path('posts/followings/',FollowingPostsView.as_view(),name='posts'),
    path('post/<int:id>/',PostView.as_view(),name='post'),
    path('post/<int:post_id>/interest/',PostsNotInterestedView.as_view(),name='post-not-interested'),
