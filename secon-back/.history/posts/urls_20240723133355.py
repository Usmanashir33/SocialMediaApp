...
urlpatterns = [
    ...
    path('comment/<int:post_id>/comments/',PostAssoComments.as_view(),name='post-comments'),
    path('comment/<int:comment_id>/comment/',PostAssoComment.as_view(),name='post-comment'),
]