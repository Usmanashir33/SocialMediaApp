    ...
    def get(self, request, user_id ,format=None):
        try:
            ...
            if friend in user.blocked_users.all() :
                ...
                inform_user_blocked(friend.id,"unblocked") # to let friend know hes blocked 
                return Response({'unblocked':"unblocked"})
            else:
                user.blocked_users.add(friend)
                inform_user_blocked(friend.id,"blocked") # to let friend know hes blocked 
