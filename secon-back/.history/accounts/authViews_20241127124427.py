...
class SetNewPassword(APIView):
    ...
    def post(self, request,format=None):
        try :
            ...
            return Response(err.detail,status=status.HTTP_200_OK)
...
class VerifyOldPasswordView(APIView):
    def post(self, request,format=None):
        ...
        return Response({"email_sent" :True } if correct else {"error" : "No account associated with this email"}) # either true or false
