...
from .authViews import VerifyOldPasswordView
from .autViews import VerifyOldPasswordView
urlpatterns = [
    ...
    # auth section
    path("auth/checkoldpassword/",VerifyOldPasswordView.as_view,name='check-old-password'),
