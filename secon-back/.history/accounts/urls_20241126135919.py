...
from .authViews import VerifyOldPasswordView,ChangeUserPasswordView,VerifyAccountOwnerView
urlpatterns = [
    ...
    path("auth/request-forget-password/",VerifyAccountOwnerView.as_view(),name='forget-password'),
