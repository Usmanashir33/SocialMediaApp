...
from .authViews import VerifyOldPasswordView,ChangeUserPasswordView,RequestForgetPWDOTP
urlpatterns = [
    ...
    path("auth/request-forget-password/",CheckFPWOTPView.as_view(),name='forget-password'),
