...
class User(AbstractUser):
    ...
    blocked_users = models.ManyToManyField('self', verbose_name=_("blocked users"), related_name='blockedby', blank=True,symmetrical=False)
    blocked_users = models.ManyToManyField('self', verbose_name=_("blocked users"), related_name='blockedby', blank=True,null=True)
